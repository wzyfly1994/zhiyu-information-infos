package com.zhiyu.security.config.swagger;
...
//        pars.add(headerPair.build());
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(Predicates.or(RequestHandlerSelectors.basePackage("com.zhiyu.security.controller")))
    ...
    private ApiInfo apiInfo() {
        String exposeHost = "127.0.0.1";
        return new ApiInfoBuilder()
                .title("授权服务 Api-IP：" + exposeHost)
