 ...
 * 2.此类依赖父类“com.zhiyu.entity.pojo.system.BaseEntity”全路径地址，移动后请更改！
 * <p>
 */
    ...
    public ElementsToProcess getElementsToProcess() {
        if (elementsToProcess == null) {
            ...
            for (int i = elements.size() - 1; i >= 0; i--) {
                if (Objects.equals(elements.get(i).getDeclaringClass().toString(), "com.zhiyu.entity.pojo.system.BaseEntity")) {
                    moveElementToLast(elements, i);
                }
            }
